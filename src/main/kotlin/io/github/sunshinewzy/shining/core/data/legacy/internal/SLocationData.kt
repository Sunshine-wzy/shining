...
import io.github.sunshinewzy.shining.core.data.DataManager.getMap
import io.github.sunshinewzy.shining.core.data.legacy.SAutoCoverSaveData
import io.github.sunshinewzy.shining.events.slocationdata.SLocationDataAddEvent
import io.github.sunshinewzy.shining.events.slocationdata.SLocationDataClearEvent
import io.github.sunshinewzy.shining.events.slocationdata.SLocationDataRemoveEvent
...
class SLocationData(val world: String) : SAutoCoverSaveData(Shining.plugin, world, "SLocationData") {
    ...
    companion object : Initable {
        ...
        fun addData(world: String, sLocation: String, key: String, value: String) {
            ...
            Shining.pluginManager.callEvent(SLocationDataAddEvent(SLocation(sLocation), key, value))
        }
