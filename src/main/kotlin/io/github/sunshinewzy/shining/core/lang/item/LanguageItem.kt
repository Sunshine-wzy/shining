...
open class LanguageItem(
    ...
    constructor(type: Material, amount: Int, node: (locale: String) -> LanguageNode) : this(
        ItemStack(type, amount),
        node
    )

    constructor(type: Material, damage: Short, amount: Int, node: (locale: String) -> LanguageNode) : this(
        ItemStack(
            type,
            amount,
            damage
