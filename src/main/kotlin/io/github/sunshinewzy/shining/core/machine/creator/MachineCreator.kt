...
object MachineCreator {
    ...
    private val itemMachineType = NamespacedIdItem(Material.GLASS, NamespacedId(Shining, "item-shining-machine-creator-type"))
    private val itemMachineAutoType = NamespacedIdItem(Material.REDSTONE_BLOCK, NamespacedId(Shining, "item-shining-machine-creator-auto"))
    private val itemMachineTypeSingle = NamespacedIdItem(Material.IRON_BLOCK, NamespacedId(Shining, "item-shining-machine-creator-type-single"))
    private val itemMachineTypeMultiple = NamespacedIdItem(Material.IRON_BLOCK, NamespacedId(Shining, "item-shining-machine-creator-type-multiple"))
