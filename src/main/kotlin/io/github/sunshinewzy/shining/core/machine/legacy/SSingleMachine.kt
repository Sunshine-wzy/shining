...
abstract class SSingleMachine(
    ...
    fun getDataOrFail(sLocation: SLocation, key: String): Any =
        getData(sLocation, key)
            ?: throw IllegalArgumentException("The SLocation '${toString()}' doesn't have SSingleMachine($id) data of $key.")
    ...
    companion object : Initable {
        ...
        fun addMachine(
            ...
            information: SSingleMachineInformation = SSingleMachineInformation()
        ) {
