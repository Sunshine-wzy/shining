...
import io.github.sunshinewzy.shining.core.data.legacy.internal.SFlatMachineData
import io.github.sunshinewzy.shining.events.smachine.SFlatMachineAddEvent
import io.github.sunshinewzy.shining.events.smachine.SFlatMachineRemoveEvent
import io.github.sunshinewzy.shining.events.smachine.SFlatMachineUseEvent
...
abstract class SFlatMachine(
    ...
    companion object : Initable {
        ...
        fun addMachine(location: Location, sFlatMachine: SFlatMachine, player: Player, face: BlockFace) {
            ...
            Shining.pluginManager.callEvent(SFlatMachineAddEvent(sFlatMachine, location, player, face))
        }
        ...
        fun removeMachine(location: Location): Boolean {
            removeMachine(location.toSLocation())?.let { sFlatMachine ->
                Shining.pluginManager.callEvent(SFlatMachineRemoveEvent(sFlatMachine, location))
                return true
            }
            return false
        }
